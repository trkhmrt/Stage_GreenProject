                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <p className="text-gray-400 text-sm">
                            Modern alışveriş deneyimi sunan e-ticaret platformumuz, en kaliteli ürünleri en uygun fiyatlarla sizlere ulaştırmayı hedefliyor.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li>
                                <a href="#" className="text-gray-400 hover:text-white transition-colors">Ürünler</a>
                            </li>
                            <li>
                                <a href="#" className="text-gray-400 hover:text-white transition-colors">Kampanyalar</a>
                            </li>
                            <li>
